...
public class RoundedCornersSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.evolution_settings_rounded_corners);
        ...
        boolean hasCustomCutout = res.getBoolean(res.getIdentifier(
                "config_customCutout", "bool", "com.android.systemui"));
        if (!hasCustomCutout) {
