...
public class PowerMenu extends SettingsPreferenceFragment implements
    ...
    private static final String KEY_GLOBAL_ACTIONS_FLASHLIGHT = "global_actions_flashlight";
    ...
    public void onCreate(Bundle icicle) {
        ...
        mPowermenuTorch = (SwitchPreference) findPreference(KEY_GLOBAL_ACTIONS_FLASHLIGHT);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mPowermenuTorch) {
            ...
            Settings.System.putInt(resolver,
                    Settings.System.GLOBAL_ACTIONS_FLASHLIGHT, value ? 1 : 0);
            return true;
        }
        return false;
    }
